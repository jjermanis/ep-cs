...
namespace unit_tests
{
    ...
    public class Solutions021to030Tests : BaseTest
    {
        ...
        public void Solutions021to030Test()
        {
            ...
            //Test(Solutions.Solution023, nameof(Solutions.Solution023), 4179871, TestSpeed.Fast);
            //Test(Solutions.Solution024, nameof(Solutions.Solution024), 2783915460, TestSpeed.Normal);
